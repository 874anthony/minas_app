...
var createPermanentPerson = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var roles, checks, corrects, citizenship, ord;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, permanentPersonModel_1.default.findOne({ citizenship: citizenship })];
            case 1:
                ord = _a.sent();
                if ((ord === null || ord === void 0 ? void 0 : ord.status) === ordinariesEnum_1.StatusOrdinary.Forbidden) {
                    roles = [userModel_1.UserRoles.SSFF];
                    checks = { checkSSFF: false };
                    corrects = {};
                }
                return [2 /*return*/, ordinaryFactory.createOrdinary(permanentPersonModel_1.default, roles, checks, corrects)(req, res, next)];
        }
    });
}); };
