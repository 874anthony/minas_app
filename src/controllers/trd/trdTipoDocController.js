...
var getAllTipoDocs = (0, catchAsync_1.default)(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var features, tipodocs;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                features = new apiFeatures_1.default(trdTipoDoc_1.default.find(), req.query)
                    .filter()
                    .sort()
                    .limitFields()
                    .paginate();
