...
exports.getSeriesByDependency = exports.updateSerie = exports.getSerie = exports.getAllSeries = exports.createSerie = void 0;
...
var getSeriesByDependency = function (req, res, next) {
    req.query.dependencyID = req.params.idDependency;
    next();
};
exports.getSeriesByDependency = getSeriesByDependency;
var createSerie = (0, handlerFactory_1.createOne)(trdSerie_1.default);
exports.createSerie = createSerie;
var getAllSeries = (0, catchAsync_1.default)(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var features, series;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                features = new apiFeatures_1.default(trdSerie_1.default.find(), req.query)
                    .filter()
                    .sort()
                    .limitFields()
                    .paginate();
