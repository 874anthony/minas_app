...
var PunctualMachinerySchema = new mongoose_1.Schema({
    radicado: {
        type: String,
...
PunctualMachinerySchema.plugin(mongoose_unique_validator_1.default, {
...
exports.default = (0, mongoose_1.model)('punctual_machinery', PunctualMachinerySchema);
